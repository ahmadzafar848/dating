...
import '../ui_screens/born_ui.dart';

class FemaleInitialWidget extends StatelessWidget {
  const FemaleInitialWidget({Key? key}) : super(key: key);
            ...
            SizedBox(
              ...
              child: Center(
                  child: Text(
                    'What is Your Name?',
                    style: TextStyle(
                        fontWeight: FontWeight.bold, fontSize: size * 0.065),
                  )),
            ),
            SizedBox(
              height: constraints.maxHeight * 0.1,
              ...
              child: Center(
                child: GestureDetector(onTap: (){
                  ...
                  child: Container(height: constraints.maxHeight * 0.07,
                    ...
                    decoration: BoxDecoration(color: AppColor.AppButtonColor10,
